...
Uses historical data from ingestion_snapshot.parquet
to compute rolling features for the games being predicted.
"""
...
class PreGameFeatureBuilder:
    ...
    canonical ingestion snapshot as historical data.
    """
