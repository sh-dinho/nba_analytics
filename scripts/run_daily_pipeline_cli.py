...
def main():
    ...
    parser.add_argument("--use-synthetic", action="store_true", help="Use synthetic player data instead of API fetch") # <-- NEW ARGUMENT
    ...
    pipeline = PredictionPipeline(
        ...
        use_synthetic=args.use_synthetic # <-- ARGUMENT PASSED
    )
